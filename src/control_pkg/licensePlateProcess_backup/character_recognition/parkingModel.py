...
class CharacterModel:
    def __init__(self):
        ...
        train_data_dir = self.homePath + '/enph353_cnn_lab/TrainingData/train'
        validation_data_dir = self.homePath + '/enph353_cnn_lab/TrainingData/validation'
    ...
    def loadWeights(self):
        self.model.load_weights(self.homePath + '/weights2.h5')

    def saveWeights(self):
        self.model.save_weights(self.homePath + '/weights2.h5')
